# RAUC: A Novel Geometric Measure for Point Processes Applied to Machine Learning
...
## Academic Reference: 
This project is based on the research by: Dylan Benavides, National High Technology Center (CeNAT), Costa Rica.

## 🤝 Contributing
Contributions are welcome! If you have suggestions for improving the geometric measure, please let me know by sending an email to [dbenavides@cenat.cr](mailto:dbenavides@cenat.cr).
